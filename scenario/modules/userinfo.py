...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n[✦ Support](https://t.me/{SUPPORT_CHAT}) | [✦ Updates](https://t.me/{UPDATES_CHANNEL})\n\n"
        ...
        update.effective_message.reply_text(
            (
                ...
                + "╘══「 by [Team Sh4dow](t.me/Official_SH4DOW_xD) 」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
...
*What is that health thingy?*
 Come and see [HP System explained](t.me/Blaze_Owner)
"""
